    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">Join JAMC and start your learning journey</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input id="classCode" name="classCode" type="text" onChange={handleChange} />
            </div>
            {error && (
